...
class LayaSystemOneClientTest {
    ...
    private JevDecisionsClient client;
    ...
    void setUp() throws IOException {
        ...
        client = new JevDecisionsClient(properties, objectMapper);
    }
    ...
    void successParsesSystemoneResponse() throws Exception {
        ...
        JevDecisionsClient.DecisionsResponse response = client.decide(
                new JevDecisionsClient.DecisionsRequest(Map.of("k", "v"), Map.of(
    ...
    void http401SurfacesAsClientError() {
        ...
        assertThrows(WebClientResponseException.class, () -> client.decide(
                new JevDecisionsClient.DecisionsRequest(Map.of(), Map.of(
                        "same_entity", Map.of("type", "noul", "instructions", "test")),
                        null, null),
    ...
    void missingApiKeyRejectedBeforeHttp() {
        ...
        assertThrows(IllegalStateException.class, () -> client.decide(
                new JevDecisionsClient.DecisionsRequest(Map.of(), Map.of(), null, null),
                Map.of(),
