...
class LayaSystemOneClientValidationTest {
    ...
    void validatesNoulChoiceAndScorePrimitives() throws Exception {
        ...
        var answers = mapper.readTree("""
                ...
                """);
        assertDoesNotThrow(() -> LayaSystemOneClient.validateAnswers(answers, expected));
    }
    ...
    void rejectsMissingAnswer() {
        ...
        assertThrows(IllegalStateException.class,
                () -> LayaSystemOneClient.validateAnswers(answers, expected));
    }
