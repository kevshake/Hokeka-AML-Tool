 ...
 * AML typed decisions use {@link JevDecisionsClient} ({@code /v1/systemone}).
 */
@Component
public class LayaAskClient {
    ...
    public LayaAskClient(JevProperties properties, ObjectMapper objectMapper) {
