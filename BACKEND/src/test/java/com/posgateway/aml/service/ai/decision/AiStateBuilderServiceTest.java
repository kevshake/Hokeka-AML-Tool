...
class AiStateBuilderServiceTest {

    private final AiStateBuilderService service = new AiStateBuilderService();
    ...
    void stripsForbiddenKeysFromBuiltState() {
        ...
        Map<String, Object> state = service.buildState(AiDecisionPoint.DP1_TM_ALERT_TRIAGE, ctx);
    ...
    void dp2StateContainsMatchFeaturesOnly() {
        ...
        AiDecisionContext ctx = AiDecisionContext.builder(AiEngineType.SANCTIONS_DISAMBIGUATION)
                .features(features)
                .build();
        Map<String, Object> state = service.buildState(AiDecisionPoint.DP2_SCREENING_MATCH, ctx);
