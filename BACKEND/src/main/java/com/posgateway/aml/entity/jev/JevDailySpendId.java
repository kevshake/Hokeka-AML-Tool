...
@Embeddable
public class JevDailySpendId implements Serializable {
    ...
    public JevDailySpendId() {
    }

    public JevDailySpendId(Long pspId, LocalDate spendDate) {
        this.pspId = pspId;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof JevDailySpendId that)) return false;
