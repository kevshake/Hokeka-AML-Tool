 ...
 * Only {@link AiDecisionGateway} should call this for production decisions.
 */
@Component
public class LayaSystemOneClient {

    private static final Logger log = LoggerFactory.getLogger(LayaSystemOneClient.class);
    ...
    public LayaSystemOneClient(AiDecisionProperties properties, ObjectMapper objectMapper) {
    ...
    public DecisionsResponse decide(DecisionsRequest request,
        ...
        String model = LayaModelRouting.requestModel(properties.getModel());
        if (model != null) {
    ...
    private DecisionsResponse executeOnce(Map<String, Object> body,
        ...
        if (!LayaModelRouting.isValidResponseModel(modelSnapshot)) {
