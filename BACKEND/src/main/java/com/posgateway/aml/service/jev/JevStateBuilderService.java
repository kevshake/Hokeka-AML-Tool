 ...
 */
@Service
public class JevStateBuilderService {
    ...
    public Map<String, Object> buildState(JevDecisionPoint decisionPoint, JevDecisionContext context) {
    ...
    private Map<String, Object> buildDp1(Map<String, Object> features, JevDecisionContext context) {
    ...
    private Map<String, Object> buildDp2(Map<String, Object> features, JevDecisionContext context) {
        Map<String, Object> state = new LinkedHashMap<>();
    ...
    private Map<String, Object> buildDp3(Map<String, Object> features, JevDecisionContext context) {
        Map<String, Object> state = new LinkedHashMap<>();
    ...
    private Map<String, Object> buildDp4(Map<String, Object> features, JevDecisionContext context) {
        Map<String, Object> state = new LinkedHashMap<>();
    ...
    private Map<String, Object> buildDp5(Map<String, Object> features, JevDecisionContext context) {
        Map<String, Object> state = new LinkedHashMap<>();
