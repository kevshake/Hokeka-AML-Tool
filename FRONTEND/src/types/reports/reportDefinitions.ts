...
export const REPORT_DEFINITIONS: ReportDefinition[] = [
  ...
  // ===== 14. CBK Reporting (6 reports) =====
  {
    id: "cbk-str",
    name: "CBK Suspicious Transaction Report (STR)",
    description: "Central Bank of Kenya STR filings and submission status",
    category: "cbk-reporting",
    type: "Regulatory",
    parameters: [
      {
        name: "period",
    ...
    supportsChart: true,
    supportsExport: ["PDF", "CSV", "Excel"],
    tags: ["cbk", "central-bank-kenya", "str", "regulatory"],
  },
  {
    id: "cbk-lctr",
    name: "CBK Large Cash Transaction Report (LCTR)",
    description: "Cash transactions exceeding CBK thresholds",
    category: "cbk-reporting",
    type: "Regulatory",
    parameters: [
      {
      ...
      { name: "from", label: "From Date", type: "date", required: true },
      { name: "to", label: "To Date", type: "date", required: true },
      { name: "threshold", label: "Threshold Amount (KES)", type: "currency", required: true, defaultValue: 1000000 },
    ],
    supportsChart: true,
    supportsExport: ["PDF", "CSV", "Excel"],
    tags: ["cbk", "central-bank-kenya", "lctr", "cash"],
  },
  {
    id: "cbk-returns",
    name: "CBK Regulatory Returns",
    description: "Mandatory CBK regulatory returns by reporting period",
    category: "cbk-reporting",
    type: "Regulatory",
    parameters: [
      {
      ...
      { name: "to", label: "To Date", type: "date", required: true },
      {
        ...
        required: false,
        options: [
          { value: "aml", label: "AML Compliance" },
    ...
    supportsChart: true,
    supportsExport: ["PDF", "CSV", "Excel"],
    tags: ["cbk", "central-bank-kenya", "returns", "regulatory"],
  },
  {
    id: "cbk-forex-monitoring",
    name: "CBK Foreign Exchange Monitoring",
    description: "FX transactions and exposure monitoring for CBK compliance",
    category: "cbk-reporting",
    type: "Compliance",
    parameters: [
      {
    ...
    supportsChart: true,
    supportsExport: ["PDF", "CSV", "Excel"],
    tags: ["cbk", "central-bank-kenya", "forex", "monitoring"],
  },
  {
    id: "cbk-cdd-compliance",
    name: "CBK Customer Due Diligence Report",
    description: "CDD and KYC compliance status for CBK regulatory requirements",
    category: "cbk-reporting",
    type: "Compliance",
    parameters: [
      {
    ...
    supportsChart: true,
    supportsExport: ["PDF", "CSV", "Excel"],
    tags: ["cbk", "central-bank-kenya", "cdd", "kyc"],
  },
  {
    id: "cbk-submission-tracker",
    name: "CBK Submission Status Tracker",
    description: "Track all CBK report submissions — submitted, pending, and failed",
    category: "cbk-reporting",
    type: "Regulatory",
    parameters: [
      {
    ...
    supportsChart: false,
    supportsExport: ["PDF", "CSV", "Excel"],
    tags: ["cbk", "central-bank-kenya", "submission", "tracking"],
  },
];
