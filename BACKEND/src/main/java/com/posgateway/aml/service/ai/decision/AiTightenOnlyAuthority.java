 ...
 */
@Component
public class AiTightenOnlyAuthority {
    ...
    static SuggestedMutation mutationFor(AiBranch branch) {
    ...
    static boolean isAllowedMutation(SuggestedMutation mutation, String baseline, AiDecisionContext context) {
    ...
    static String tightenDecision(String baseline, AiBranch branch) {
