 ...
 */
public final class AiDecisionContext {

    private final AiEngineType engine;
    ...
    private AiDecisionContext(Builder builder) {
    ...
    public static Builder builder(AiEngineType engine) {
    ...
    public static final class Builder {
        ...
        private Builder(AiEngineType engine) {
            this.engine = engine;
        }
        ...
        public AiDecisionContext build() {
            return new AiDecisionContext(this);
        }
    }
}
